...
In diesem Abschnitt wird ein Einstieg in das Problem des kürzesten Pfades (engl. Shortest Path Problem, SSP) gegeben. Ein optimaler kürzester Pfad besitzt eine möglichst kurze Distanz von Start zum Ziel. Das Problem des kürzesten Pfades in der Graphentheorie ist ein gut untersuchtes Thema der Informatik\cite{Madkour.2017}.
