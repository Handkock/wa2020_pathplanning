...
Pfadplanung im Hinblick auf Graphentheorie wird in zwei Gruppen unterteilt: informierte und uninformierte Algorithmen. Uninformierte Pfadplanung oder Blindsuche %todo "Uninformierte Pfadplanung (auch Blindsuche genannt)"?
wird in alle Richtungen durchgeführt. In der informierten Pfadplanung wird die Richtung zum Ziel geschätzt und die Suche in diese Richtung durchgeführt\cite{comAnal}. %todo synonym zum durchführen, weil 2 mal benutzt
%todo vielleicht "wird zunächst die Richtung zum Ziel geschätzt und dann die Suche in diese Richtung durchgeführt"?
